...
echo "Creating image..."
GOARCH=$ARCH $GOPATH/bin/u-root -base $TMPDIR/base.cpio -build bb -o $TMPDIR/initramfs.cpio github.com/u-root/u-root/cmds/core/* github.com/hpc/kraken/{build/u-root/kraken,utils/layer0/uinit} 2>&1
