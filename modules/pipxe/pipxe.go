...
//go:generate protoc -I ../../core/proto/src -I . --gogo_out=plugins=grpc:. pipxe.proto
...
import (
	...
	rpipb "github.com/kraken-hpc/kraken/extensions/rpi3"
...
func (*PiPXE) Name() string { return "github.com/kraken-hpc/kraken/modules/pipxe" }
