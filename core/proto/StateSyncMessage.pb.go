...
func (*StateSyncMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_StateSyncMessage_1ebda1d7aeb47789, []int{0}
}
...
func (*PhoneHomeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_StateSyncMessage_1ebda1d7aeb47789, []int{1}
}
...
type PhoneHomeReply struct {
	...
	Msg                  *StateSyncMessage `protobuf:"bytes,3,opt,name=msg,proto3" json:"msg,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (*PhoneHomeReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_StateSyncMessage_1ebda1d7aeb47789, []int{2}
}
...
func (m *PhoneHomeReply) GetMsg() *StateSyncMessage {
	if m != nil {
		return m.Msg
	}
	return nil
...
func init() {
	proto.RegisterFile("StateSyncMessage.proto", fileDescriptor_StateSyncMessage_1ebda1d7aeb47789)
}

var fileDescriptor_StateSyncMessage_1ebda1d7aeb47789 = []byte{
	...
	0xc8, 0xcf, 0x4d, 0x0d, 0x4a, 0x2d, 0x2c, 0x4d, 0x2d, 0x2e, 0x41, 0x37, 0x51, 0x29, 0x9e, 0x8b,
	0x0f, 0x49, 0x4d, 0x41, 0x4e, 0xa5, 0x90, 0x00, 0x17, 0x73, 0x01, 0x5c, 0x09, 0x88, 0x09, 0x12,
	0xc9, 0x4e, 0xad, 0x84, 0x5a, 0x0a, 0x62, 0x0a, 0x69, 0x72, 0x31, 0xe7, 0x16, 0xa7, 0x83, 0xed,
	0xe3, 0x36, 0x12, 0x87, 0xf8, 0x43, 0x0f, 0xdd, 0xf5, 0x41, 0x20, 0x35, 0x46, 0xbe, 0x5c, 0x9c,
	0x70, 0x09, 0x21, 0x07, 0x2e, 0x9e, 0xa0, 0x00, 0x67, 0xb8, 0x85, 0x42, 0x30, 0xad, 0xe8, 0xce,
	0x94, 0x12, 0xc5, 0x94, 0x28, 0xc8, 0xa9, 0x54, 0x62, 0x48, 0x62, 0x03, 0x8b, 0x1b, 0x03, 0x02,
	0x00, 0x00, 0xff, 0xff, 0x1c, 0xf7, 0xc3, 0x5e, 0x4d, 0x01, 0x00, 0x00,
}
