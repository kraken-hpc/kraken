...
func (sme *StateMutationEngine) nodeViolatesDeps(deps map[string]lib.StateSpec, node *mutationNode) (reqs []string, excs []string) {
...
func (sme *StateMutationEngine) printDeps(deps map[string]lib.StateSpec) {
