...
func (HostThermal_CPU_TEMP_STATE) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_HostThermal_704facc486675ead, []int{0, 0}
}
...
func (*HostThermal) Descriptor() ([]byte, []int) {
	return fileDescriptor_HostThermal_704facc486675ead, []int{0}
}
...
func init() { proto.RegisterFile("HostThermal.proto", fileDescriptor_HostThermal_704facc486675ead) }

var fileDescriptor_HostThermal_704facc486675ead = []byte{
