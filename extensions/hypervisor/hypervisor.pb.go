...
func init() {
	proto.RegisterType((*VirtualMachine)(nil), "Hypervisor.VirtualMachine")
	golang_proto.RegisterType((*VirtualMachine)(nil), "Hypervisor.VirtualMachine")
}

func init() { proto.RegisterFile("hypervisor.proto", fileDescriptor_7b34fdb27c05edf8) }
func init() { golang_proto.RegisterFile("hypervisor.proto", fileDescriptor_7b34fdb27c05edf8) }

var fileDescriptor_7b34fdb27c05edf8 = []byte{
	// 193 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *VirtualMachine) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Uuid) > 0 {
		i -= len(m.Uuid)
		copy(dAtA[i:], m.Uuid)
		i = encodeVarintHypervisor(dAtA, i, uint64(len(m.Uuid)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.VmName) > 0 {
		...
		i = encodeVarintHypervisor(dAtA, i, uint64(len(m.VmName)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ApiServer) > 0 {
		...
		i = encodeVarintHypervisor(dAtA, i, uint64(len(m.ApiServer)))
		i--
		dAtA[i] = 0xa
	}
